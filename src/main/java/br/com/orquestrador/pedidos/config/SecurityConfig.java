...
import br.com.orquestrador.pedidos.security.CustomAccessDeniedHandler;
import br.com.orquestrador.pedidos.security.CustomAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authenticationEntryPoint(customAuthenticationEntryPoint) // token nao enviado
                .accessDeniedHandler(customAccessDeniedHandler)           // token invalido
                )
                ...
                .addFilterBefore(jwtRequestFilter, UsernamePasswordAuthenticationFilter.class) //envia todas as requisicoes para o nosso filtro
                .build();
    }
